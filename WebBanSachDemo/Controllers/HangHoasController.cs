...
namespace WebBanSachDemo.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(WebBanSachDemoContext context)
        {
            _context = context;
        }
        ...
        {
            var webBanSachDemoContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await webBanSachDemoContext.ToListAsync());
        }
